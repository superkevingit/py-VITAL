...
opts['model_path'] = '../models/mdnet_got.pth'
...
opts['GAN_lr_pretrain'] = 0.001
opts['GAN_maxiter_pretrain'] = 100
opts['GAN_mask_batch_size'] = 128
opts['GAN_batch_size'] = 32
opts['GAN_lr_update'] = 0.005
